<template>
    <jet-action-section>
        ...
        <template #description>
            他のブラウザやデバイスでアクティブなセッションを管理してログアウトします。
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                必要に応じて、すべてのデバイスで他のすべてのブラウザセッションからログアウトできます。最近のセッションのいくつかを以下に示します。ただし、このリストはすべてを網羅しているわけではありません。アカウントが侵害されたと思われる場合は、パスワードも更新する必要があります。
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    パスワードを入力して、すべてのデバイスで他のブラウザセッションからログアウトすることを確認してください
