<template>
  <app-layout>
    ...
    <div class="flex items-center p-4 lg:justify-center">
      ...
      >
        <div
          class="p-4 py-6 text-white bg-yellow-400 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
          <p class="mt-2 text-4xl font-bold tracking-wider text-center">
            練習場所を投稿しよう！
          </p>
          <p class="mt-2 font-normal text-center text-blue-900 md:mt-0">
            周りの人への挨拶やゴミの持ち帰りなど、マナーを守って気持ちよく練習場所を共有しましょう！<br /><br />
...
export default {
  ...
  methods: {
    submit() {
      this.form.post(route("places.update", this.place.id), {
